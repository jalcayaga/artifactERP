            ...
            <div className="container">
                ...
                <div className="pricing-grid">
                    <div className="plan-card">
                        ...
                        <a href="#contacto" className="plan-button">Comenzar Ahora</a>
                    </div>
                    ...
                    <div className="plan-card popular">
                        ...
                        <a href="#contacto" className="plan-button">Elegir Plan</a>
                    </div>
                    ...
                    <div className="plan-card">
                        ...
                        <a href="#contacto" className="plan-button">Solicitar Cotización</a>
                    </div>
                </div>
            </div>
        </section>
