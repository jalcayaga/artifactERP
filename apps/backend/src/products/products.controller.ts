...
export class ProductsController {
  ...
  uploadTechnicalSheet(
    ...
    return this.productsService.updateTechnicalSheet(tenantId, id, file.filename);
  }
  ...
  findPublished(
    ...
    const filters = {
      category,
      searchQuery,
      minPrice: parsedMinPrice !== undefined && !isNaN(parsedMinPrice) ? parsedMinPrice : undefined,
      maxPrice: parsedMaxPrice !== undefined && !isNaN(parsedMaxPrice) ? parsedMaxPrice : undefined,
    };
  ...
  @Patch(':id')
  update(@TenantId() tenantId: string, @Param('id') id: string, @Body() updateProductDto: UpdateProductDto) {
