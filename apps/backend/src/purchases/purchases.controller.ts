...
export class PurchasesController {
  ...
  @Post()
  create(@TenantId() tenantId: string, @Body() createPurchaseDto: CreatePurchaseDto) {
  ...
  @Patch(':id')
  update(@TenantId() tenantId: string, @Param('id') id: string, @Body() updatePurchaseDto: UpdatePurchaseDto) {
