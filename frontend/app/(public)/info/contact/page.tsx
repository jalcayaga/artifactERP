...
import {
  ...
  HomeIcon,
  TagIcon,
} from '@/components/Icons' // Reusing TagIcon for phone/email
        ...
        <Card className='border shadow-lg'>
          <CardHeader className='text-center pb-4'>
            ...
            <p className='text-muted-foreground mt-2'>
              ...
              través de los siguientes medios o visítanos.
            </p>
          </CardHeader>
          <CardContent className='space-y-8 pt-6'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
              ...
              <div className='space-y-3'>
                ...
                <p className='text-muted-foreground'>
                  <a
                    href='https://maps.google.com/?q=[TuDireccionGoogleMaps]'
                    target='_blank'
            ...
            <div className='pt-6 border-t border-border'>
              ...
              <p className='text-sm text-muted-foreground text-center italic'>
                (Formulario de contacto en desarrollo. Por favor, utiliza
                nuestro email o teléfono.)
              </p>
              {/* 
