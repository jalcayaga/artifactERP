          ...
          <CardContent className="p-3 flex flex-col flex-grow justify-between">
            ...
            <div className="mt-1">
              ...
              <button 
                ...
                onClick={(e) => { e.preventDefault(); alert('Agregar al carro: Próximamente');}}
              >
                Agregar al carro
              </button>
            </div>
...
const ps5OfferNew = { id: 'ps5-oferta-new', imageUrl: 'https://placehold.co/300x400/000000/FFFFFF?text=PS5+Oferta', imageAlt: 'Oferta Consola PlayStation 5', ctaLink: '/products/placeholder-ps5' };
const asusOfferNew = { id: 'asus-oferta-new', imageUrl: 'https://placehold.co/640x360/1A202C/FFFFFF?text=ASUS+Zenbook', imageAlt: 'Oferta ASUS Zenbook 14 OLED', ctaLink: '/products/placeholder-asus' };
const zteSmartphoneOfferNew = { id: 'zte-oferta-new', imageUrl: 'https://placehold.co/700x350/D53F8C/FFFFFF?text=ZTE+Nubia', imageAlt: 'Oferta Smartphone ZTE Nubia Neo2', ctaLink: '/products/placeholder-zte' };
const gearMonitorsBannerNew = { id: 'gear-monitors-banner-new', imageUrl: 'https://placehold.co/950x250/2D3748/FFFFFF?text=Monitores+Gear', imageAlt: 'Promoción Monitores Gear para trabajar o jugar', ctaLink: '/products/category/monitors' };
const headphonesOfferNew = { id: 'headphones-oferta-new', imageUrl: 'https://placehold.co/400x400/C53030/FFFFFF?text=HyperX', imageAlt: 'Oferta Audífonos Gamer HyperX', ctaLink: '/products/placeholder-headphones' };
const cameraOfferNew = { id: 'camera-oferta-new', imageUrl: 'https://placehold.co/400x400/4A5568/FFFFFF?text=Canon+Reflex', imageAlt: 'Oferta Cámara Reflex Canon', ctaLink: '/products/placeholder-camera' };
    ...
    const fetchAlarmProducts = async () => {
      ...
      try {
        ...
        if (!productsToDisplay || productsToDisplay.length === 0) {
            const fallbackResponse = await ProductService.getPublishedProducts(1, 5);
        ...
        if (!productsToDisplay || productsToDisplay.length === 0) {
          ...
          const productsWithDemoOffer = productsToDisplay.map((p: Product, index: number) => {
            if (index % 2 === 0 && p.price > 50000 && p.productType === 'PRODUCT') {
  ...
  return (
    <div className="bg-background text-foreground">
      <section 
        ...
        style={{ backgroundImage: `url(https://placehold.co/1600x600/31343C/FFFFFF?text=SubRed+Soluciones)` }}
        ...
        <div className="container mx-auto px-4 text-center text-white">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 pt-8">
            <div className="flex flex-col items-center p-2">
              ...
              <p className="text-sm text-white/80 leading-relaxed">Productos de marcas líderes y soluciones de seguridad probadas y confiables.</p>
            </div>
            <div className="flex flex-col items-center p-2">
              <div className="bg-black/25 dark:bg-black/40 p-4 rounded-full mb-4 inline-block shadow-md transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-lg dark:hover:shadow-primary/20">
              ...
              <p className="text-sm text-white/80 leading-relaxed">Te guiamos para encontrar la tecnología ideal para tu protección y necesidades.</p>
            </div>
            <div className="flex flex-col items-center p-2">
              <div className="bg-black/25 dark:bg-black/40 p-4 rounded-full mb-4 inline-block shadow-md transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-lg dark:hover:shadow-primary/20">
              ...
              <p className="text-sm text-white/80 leading-relaxed">Servicio técnico certificado para un funcionamiento impecable y eficiente.</p>
            </div>
            <div className="flex flex-col items-center p-2">
              <div className="bg-black/25 dark:bg-black/40 p-4 rounded-full mb-4 inline-block shadow-md transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-lg dark:hover:shadow-primary/20">
              ...
              <p className="text-sm text-white/80 leading-relaxed">Asistencia continua para garantizar tu tranquilidad y la máxima satisfacción.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-6 sm:py-8 md:py-10 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6">
            <div className="md:col-span-3 aspect-[3/4]"><FeaturedOfferCard product={ps5OfferNew} /></div>
            <div className="md:col-span-4 aspect-[16/9]"><FeaturedOfferCard product={asusOfferNew} /></div>
            <div className="md:col-span-5 aspect-[2/1]"><FeaturedOfferCard product={zteSmartphoneOfferNew} /></div>
            <div className="md:col-span-12 aspect-[19/5]"><FeaturedOfferCard product={gearMonitorsBannerNew} /></div>
            <div className="md:col-span-3 aspect-square"><FeaturedOfferCard product={headphonesOfferNew} /></div>
            <div className="md:col-span-3 aspect-square"><FeaturedOfferCard product={cameraOfferNew} /></div>
          </div>
        </div>
      </section>
