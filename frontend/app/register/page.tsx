  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        {successMessage ? (
            <CheckCircleIcon className="mx-auto h-12 w-auto text-emerald-500" />
        ) : (
        ...
        {!successMessage && (
          <p className="mt-2 text-sm text-muted-foreground">
            ...
            <Link 
              href="/login"
              className={`font-medium text-primary hover:text-primary/80 dark:hover:text-primary/70 ${isLoading ? 'opacity-50 pointer-events-none' : ''}`}
            >
              Inicia sesión
            </Link>
          </p>
