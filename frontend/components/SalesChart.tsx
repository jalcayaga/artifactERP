...
const SalesChart: React.FC = () => {
  ...
  useEffect(() => {
    ...
    chartInstanceRef.current = new Chart(canvasCtx, { // Use the imported Chart object
      type: 'line',
      data: {
        labels: labels,
        datasets: [{
  ...
  return (
    <div style={{ height: '350px', position: 'relative' }} key={chartKey}> 
      <canvas ref={chartRef} role="img" aria-label="Gráfico de resumen de ventas mensuales"></canvas>
    </div>
  );
};
