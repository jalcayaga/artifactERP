...
import { Company, CreateCompanyDto, UpdateCompanyDto, CompanyFilterOptions } from '@/lib/types';
...
export default function CompanyView({ show }: CompanyViewProps) {
  ...
  const columns = useMemo(() => getColumns(handleEdit, handleDeleteRequest, handleView), [handleEdit, handleDeleteRequest, handleView]);
