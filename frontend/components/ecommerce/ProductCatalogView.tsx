    ...
    <Link href={`/products/${product.id}`} className='group block h-full'>
      <Card className='overflow-hidden shadow-lg hover:shadow-primary/30 transition-all duration-300 h-full flex flex-col border border-border'>
        ...
        <CardContent className='p-4 flex flex-col flex-grow'>
          <h3
            className='text-md font-semibold text-foreground mb-1 group-hover:text-primary transition-colors truncate'
    ...
    <div className='container mx-auto px-4 sm:px-6 lg:px-8 py-8'>
      <div className='mb-8 text-center'>
        ...
        <p className='mt-3 text-lg text-muted-foreground max-w-2xl mx-auto'>
          Encuentra la tecnología que necesitas para proteger tu hogar o
          negocio.
        </p>
      </div>
