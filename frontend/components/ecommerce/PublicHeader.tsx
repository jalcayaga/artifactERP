...
import {
  ...
  MenuIcon,
  XIcon,
} from '@/components/Icons' // Ensured ShieldCheckIcon is imported
    ...
    <header className='sticky top-0 z-50 w-full backdrop-blur-lg bg-background/85 dark:bg-background/75 border-b border-border/70 shadow-sm'>
      <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='flex items-center justify-between h-14 md:h-16'>
          ...
          >
            ...
            <span className='ml-2 text-xl font-bold'>
              <span className='text-secondary group-hover:text-secondary/90 transition-colors'>
                Sub
              </span>
        ...
        {isMobileMenuOpen && (
          <div
            id='mobile-menu'
            className='md:hidden border-t border-border/70 py-3'
          >
