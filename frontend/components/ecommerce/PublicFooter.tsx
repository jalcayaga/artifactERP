...
import {
  ...
  XTwitterIcon,
  LinkedInIcon,
} from '@/components/Icons' // Import social icons
    ...
    <footer className='bg-card border-t border-border/50 relative z-10'>
      <div className='container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16'>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8'>
          ...
          <div className='md:col-span-1 space-y-3 text-center md:text-left lg:col-span-1'>
            ...
            <p className='text-sm text-muted-foreground'>
              Tu fuente confiable para productos de seguridad y tecnología de
              vanguardia.
            </p>
          </div>
          ...
          {/* Quick Links */}
          <div>
            <h3 className='text-md font-semibold text-foreground mb-3 tracking-wide'>
              Enlaces Rápidos
            </h3>
        ...
        <div className='mt-10 pt-8 border-t border-border/50 text-center'>
          <p className='text-sm text-muted-foreground'>
            &copy; {currentYear} SubRed Soluciones. Todos los derechos
            reservados.
          </p>
          <p className='text-xs text-muted-foreground/70 mt-1'>
            Una solución de <span className='font-semibold'>SubRed</span>{' '}
