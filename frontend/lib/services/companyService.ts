...
import { Company, CreateCompanyDto, UpdateCompanyDto, PaginatedResponse } from '@/lib/types';

export const CompanyService = {
  async getAllCompanies(page: number = 1, limit: number = 10, filters: { isClient?: boolean; isSupplier?: boolean } = {}): Promise<PaginatedResponse<Company>> {
