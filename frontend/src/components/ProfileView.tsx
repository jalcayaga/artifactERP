...
import { UserCircleIcon, PencilIcon, LockClosedIcon } from "@/icons";
        ...
        <CardContent className="p-6 space-y-6">
          ...
          {isEditing && (
            <div className="flex justify-end space-x-3 pt-4 border-t">
              ...
              <button
                onClick={handleSave}
                className="bg-primary hover:bg-primary/90 text-primary-foreground font-medium py-2 px-4 rounded-lg shadow-sm transition-colors"
              >
                Guardar Cambios
              </button>
            </div>
