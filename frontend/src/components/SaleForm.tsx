...
import { ShoppingCartIcon, PlusIcon, TrashIcon } from "@/icons";
            ...
            <div className="grid grid-cols-1 sm:grid-cols-12 gap-4 items-end">
              ...
              <div className="sm:col-span-2">
                ...
                <input
                  ...
                  placeholder="0"
                  className={`${inputBaseClass} py-1.5 text-sm`}
                  aria-describedby="itemQuantity-error"
                />
                {itemErrors.quantity && (
                  <p
              ...
              <div className="sm:col-span-3">
                ...
                <input
                  ...
                  step="0.01"
                  className={`${inputBaseClass} py-1.5 text-sm`}
                  aria-describedby="itemPrice-error"
                />
                {itemErrors.price && (
                  <p
                    id="itemPrice-error"
              ...
              <div className="sm:col-span-2">
                <button
                  ...
                  aria-label="Añadir artículo a la venta"
                >
