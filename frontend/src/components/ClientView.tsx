...
import ClientForm from "@/custom-components/ClientForm";
import ClientDetailModal from "@/custom-components/ClientDetailModal";
            ...
            {clients.length > 0 ? (
                ...
                <table className="min-w-full divide-y divide-border">
                  <thead className="bg-muted/50">
                    <tr>
                      ...
                      <th
                        scope="col"
                        className="px-6 py-3 text-left text-xs font-semibold text-muted-foreground uppercase tracking-wider hidden sm:table-cell"
                      >
                        Email
                      </th>
                      <th
                        scope="col"
                        className="px-6 py-3 text-left text-xs font-semibold text-muted-foreground uppercase tracking-wider hidden md:table-cell"
                      >
                        Teléfono
                      </th>
                      <th
                      ...
                      <th
                        scope="col"
                        className="px-6 py-3 text-center text-xs font-semibold text-muted-foreground uppercase tracking-wider"
                      >
                        Acciones
                      </th>
                    </tr>
              ...
              <div className="text-center py-12 px-4">
                ...
                <p className="mt-1.5 text-sm text-muted-foreground">
                  Empieza añadiendo tu primer cliente para gestionar sus datos y
                  actividades.
                </p>
                <div className="mt-6">
                  <button
